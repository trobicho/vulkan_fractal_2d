...
/*   Updated: 2021/10/26 20:24:29 by trobicho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Basic_vulk::~Basic_vulk()
{
	...
	for (auto &pipeline : m_pipelines_float)
		vkDestroyPipeline(m_device, pipeline, nullptr);
	for (auto &pipeline : m_pipelines_double)
		vkDestroyPipeline(m_device, pipeline, nullptr);
	vkDestroyPipelineLayout(m_device, m_pipeline_layout_float, nullptr);
	vkDestroyPipelineLayout(m_device, m_pipeline_layout_double, nullptr);
